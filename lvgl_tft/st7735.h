...
#define ST7735_DC       CONFIG_LV_DISP_PIN_DC
#define ST7735_RST      CONFIG_LV_DISP_PIN_RST
#define ST7735_USE_RST  CONFIG_LV_DISP_USE_RST

#define ST7735_INVERT_COLORS CONFIG_LV_INVERT_COLORS
