 ...
 *  STATIC VARIABLES
 **********************/
uint8_t st7735_portrait_mode = 0;
...
void st7735_init(void)
{
	...
	st7735_portrait_mode = 1;
#else
	st7735_portrait_mode = 0;
#endif

	st7735_set_orientation(CONFIG_LV_DISPLAY_ORIENTATION);
}
...
static void st7735_send_cmd(uint8_t cmd)
{
	...
	gpio_set_level(ST7735_DC, 0); /*Command mode*/
...
{
	disp_wait_for_pending_transactions();
	gpio_set_level(ST7735_DC, 1); /*Data mode*/
